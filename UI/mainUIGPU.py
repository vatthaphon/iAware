...
from vispy import plot as vplt
...
threeD_plot_type_g                      = 3 # 0 for the line plot, 1 for the surface plot, 2 for the scatter plot, 3 for the vispy.
        ...
        if ui_name_g == "mainUIV2.ui":
            ...
            ##### Do 3D plot. The scatter plot version.
                ...
                for i_time_l in range(threeD_N_time_EEG_data_fft_lin_g):
                    ...
                    self.__ui.threeDplots.addItem(self.__traces[i_time_l])            
            elif threeD_plot_type_g == 3:
            ##### Do 3D plot. The GPU surface version.
                self.__ui.gridLayout_5.addWidget(QPushButton())
                # fig = vplt.Fig(size=(600, 500), show=False)
                ...
                # self.__ui.threeDplots.addItem(vcanvas.native)
